...
public class LearningPlanController {
  ...
  public LearningPlan create(@RequestBody LearningPlanRQ rq,
    ...
    System.out.println("Received create learning plan request:");
    System.out.println("User ID: " + userId);
    System.out.println("Request body: " + rq);
    try {
      LearningPlan result = learningPlanService.create(rq, userId);
      System.out.println("Successfully created learning plan with ID: " + result.getId());
      return result;
    } catch (Exception e) {
