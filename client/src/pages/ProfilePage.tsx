...
const mockPlans: LearningPlan[] = [
  {
    ...
    subject: 'Photography', // Changed from 'Maths' to valid enum value based on lint error
    topics: [
      {
        id: 'topic-5',
...
const mockUpdates: ProgressUpdate[] = [
  {
    ...
    subject: 'Photography', // Changed from 'Maths' to valid subject type
    user: {
      id: '1',
      name: 'Alex Johnson',
      username: 'alexj',
  ...
  },
  {
    ...
    subject: 'Photography', // Changed to valid subject type
    user: {
      id: '1',
      name: 'Alex Johnson',
      username: 'alexj',
